...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String LAYER_APP_ID = "layer:///apps/staging/a0b80650-38a3-11e6-a07b-a625000000b4";
...
/*      if(Build.FINGERPRINT.contains("generic"))
    ...
    public static List<String> getAllParticipants(){
        return Arrays.asList("saivivek512@gmail.com","raviteja2048@gmail.com");
    }
    ...
    public void onUserAuthenticated(){
        ...
        if(conversationView == null) {
            conversationView = new ConversationViewController(this, layerClient,category);
            if (layerClient != null) {
                layerClient.registerTypingIndicator(conversationView);
            }
