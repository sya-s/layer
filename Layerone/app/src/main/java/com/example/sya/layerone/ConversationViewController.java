 ...
 * messages in the GUI.
 */
public class ConversationViewController extends AppCompatActivity implements View.OnClickListener, LayerChangeEventListener,
...
//------------------------------------------------------------------------------------------------------------
    ...
    public ConversationViewController(MainActivity ma, LayerClient client, String category) {
    ...
    public static String getInitialMessage() {
        ...
        String name = MainActivity.getUserID();
        return "Hey, everyone! This is your friend, " + name ;
    }
    ...
    private void sendButtonClicked() {
        ...
        if (activeConversation == null) {
            ...
            if (activeConversation == null) {
                ...
                metadata.put("title",category);
                activeConversation = layerClient.newConversation(options,MainActivity.getAllParticipants());
    ...
    private Conversation getConversation() {
        ...
        if (activeConversation == null) {
            ...
            if (results != null && results.size() > 0) {
                if (results.get(0) == null || results.get(0).getMetadata() == null || results.get(0).getMetadata().get("title") == null) {
                    return results.get(0);
                }
                else if (results.get(0).getMetadata().get("title").equals(category)){
                    return results.get(0);
                }
                else {
                    return null;
